...
const randomImage = 'https://source.unsplash.com/random/1600x900/?technology,nature,photography';
      ...
      <div className="flex flex-col pb-5">
        <div className="relative flex flex-col mb-7">
          <div className="flex flex-col justify-center items-center">
            <img src={randomImage} alt="banner-image" className='w-full h-370 2xl:h-510  shadow-lg object-cover'/>
          ...
          : (
            <div className="flex justify-center items-center font-bold w-full text-lg mt-2">No pins found</div>
          )
          }
        </div>
      </div>
